...
# To do that, you must go to learnpythonthehardway.org/python3/exercise26.txt
# Copy and paste the code into a file named ex26.py, then fix the errors.

# In this exercise, you will practice dealing with a bad programmer by fixing
#   a bad programmer's code.  Ex24 and 25 are copied into this exercise and 
#   then random characters were removed, while adding some flaws.
